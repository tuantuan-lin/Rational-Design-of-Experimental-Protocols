...
def model_pre(x, y, name, path, space_pre):
    params = np.load(
...
if __name__ == '__main__':
    ...
    for u in range(0, m):
        ...
        predict_y = model_pre(x11, y11, 'xgboost',
                              r'G:\Grade one\9-Dataset\07-Ce-TGA\04-建模\07-回归任务-1114\02-model\xgboost.pkl'
                              , space_pre)
        print(u)
    ...
    data_write(pre_all, "07-Tem_pas.xlsx")
